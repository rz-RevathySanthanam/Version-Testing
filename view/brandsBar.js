...
const SupportLinkItem = ({ name, href, children }) => {
  let item = (
    <Row alignCenter>
...
export const SupportLinks = () => {
  return (
    <Row css={QuickLinksCss}>
      <SupportLinkItem name="Sími +1 (855) 2SPORT4" href="tel:+18552776784">
        <CallIcon />
      </SupportLinkItem>
      <SupportLinkItem name="Netklúbbur" href="/netklubbur">
        <CardIcon />
      </SupportLinkItem>
      <SupportLinkItem
        name="Mínar síður"
...
`;
export const BaseBrandsBarView = () => {
  return (
    <BarRow spaceBetween>
      <Col>
        <BrandsView />
